...
"""Модуль выбора персонажа и базовых действий"""


def attack(char_name: str, char_class: str) -> str:
    """Возвращает урон по противнику."""
...
def special(char_name: str, char_class: str) -> str:
    """Возвращает приминённое умение и его значение."""
    if char_class == 'warrior':
...
def start_training(char_name: str, char_class: str) -> str:
    """Возвращает информацию о персонаже и его действии."""
    if char_class == 'warrior':
